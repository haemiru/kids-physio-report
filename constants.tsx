...
export const MOCK_PATIENTS = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/child1/200/200'
  },
  {
    id: 'p2',
    name: '박민준',
    age: 5,
    diagnosis: 'GMFCS Level III',
    guardianName: '박성호',
    contact: '010-9876-5432',
    imageUrl: 'https://picsum.photos/seed/child2/200/200'
  }
];
